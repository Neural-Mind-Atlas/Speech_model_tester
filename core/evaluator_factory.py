...
"""
TTS/STT Testing Framework - Evaluator Factory

This module provides a factory for creating TTS and STT evaluators.
It manages evaluator instantiation, configuration, and lifecycle.
...
class EvaluatorFactory:
    """
    Factory class for creating TTS and STT evaluators.
    
    This factory manages the creation and configuration of evaluators
    based on the evaluation type and configuration settings.
    """
    ...
    def get_available_evaluators(self) -> List[str]:
        ...
        Returns:
            List[str]: List of available evaluator types
        """
        return list(self._evaluators.keys())
    
    def is_evaluator_available(self, evaluator_type: str) -> bool:
        """
