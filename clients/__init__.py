...
try:
    ...
    # Create a placeholder for GoogleClient
    GoogleClient = None

try:
    from .elevenlabs_client import ElevenLabsClient
    _available_clients.append('ElevenLabsClient')
    logger.info("Successfully imported ElevenLabsClient")
except ImportError as e:
    logger.warning(f"Failed to import ElevenLabsClient: {e}")
    _import_errors.append(('ElevenLabsClient', str(e)))
